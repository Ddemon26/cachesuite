...
if (abyte0 == null)
		...
		public void method466()
		{
			...
			anInt1653 = (int)(Math.Sqrt(anInt1650 * anInt1650 + base.modelHeight * base.modelHeight) + 0.98999999999999999D);
		...
		private void method468()
		{
			...
			anInt1653 = (int)Math.Sqrt(anInt1650 * anInt1650 + base.modelHeight * base.modelHeight);
		...
		public void method470(int i)
		{
			...
			if (class36 == null)
				return;
			ModelTransform class18 = class36.aModelTransform_637;
			anInt1681 = 0;
			anInt1682 = 0;
			anInt1683 = 0;
		...
		public void Light(int i, int j, int k, int l, int i1, bool flag)
		{
			...
			for (int i2 = 0; i2 < TriangleCount; i2++)
			{
				...
				{
					VertexNormal class33_2 = base.aVertexNormalArray1425[j2];
					class33_2.anInt602 += l4;
					class33_2.anInt603 += i5;
					class33_2.anInt604 += j5;
					class33_2.anInt605++;
					class33_2 = base.aVertexNormalArray1425[l2];
					class33_2.anInt602 += l4;
					class33_2.anInt603 += i5;
					class33_2.anInt604 += j5;
					class33_2.anInt605++;
					class33_2 = base.aVertexNormalArray1425[i3];
					class33_2.anInt602 += l4;
					class33_2.anInt603 += i5;
					class33_2.anInt604 += j5;
					class33_2.anInt605++;
			...
			for (int j1 = 0; j1 < TriangleCount; j1++)
			{
				...
				if (anIntArray1637 == null)
				{
					...
					if ((anIntArray1637[j1] & 1) == 0)
					{
						...
						VertexNormal class33_1 = base.aVertexNormalArray1425[k1];
						...
						class33_1 = base.aVertexNormalArray1425[i2];
						...
						class33_1 = base.aVertexNormalArray1425[j2];
						l2 = i + (k * class33_1.anInt602 + l * class33_1.anInt603 + i1 * class33_1.anInt604) / (j * class33_1.anInt605);
						anIntArray1636[j1] = method481(j3, l2, k3);
					}
			}

			base.aVertexNormalArray1425 = null;
		...
		public void Render(int pitch, int k, int yaw, int x, int y, int z)
		{
		...
		//method81
		public override void Render(int i, int y_camera_sin, int y_camera_cos, int x_curve_sin, int x_curve_cos, int x, int y,
				int z, int i2)
		{
			int j2 = z * x_curve_cos - x * x_curve_sin >> 16;
			int k2 = y * y_camera_sin + j2 * y_camera_cos >> 16;
			int l2 = anInt1650 * y_camera_cos >> 16;
			int i3 = k2 + l2;
			if (i3 <= 50 || k2 >= 3500)
				return;
			int j3 = z * x_curve_sin + x * x_curve_cos >> 16;
			...
			if (l3 / i3 <= -DrawingArea.centerY)
				return;
			int i4 = y * y_camera_cos - j2 * y_camera_sin >> 16;
			int j4 = anInt1650 * y_camera_sin >> 16;
			int k4 = i4 + j4 << 9;
			if (k4 / i3 <= -DrawingArea.anInt1387)
				return;
			int l4 = j4 + (base.modelHeight * y_camera_cos >> 16);
			int i5 = i4 - l4 << 9;
			if (i5 / i3 >= DrawingArea.anInt1387)
				return;
			int j5 = l2 + (base.modelHeight * y_camera_sin >> 16);
			bool flag = false;
			if (k2 - j5 <= 50)
				flag = true;
			bool flag1 = false;
			...
			for (int j7 = 0; j7 < VertexCount; j7++)
			{
				...
				l7 += y;
				i8 += z;
				int k8 = i8 * x_curve_sin + k7 * x_curve_cos >> 16;
				i8 = i8 * x_curve_cos - k7 * x_curve_sin >> 16;
				k7 = k8;
				k8 = l7 * y_camera_cos - i8 * y_camera_sin >> 16;
				i8 = l7 * y_camera_sin + i8 * y_camera_cos >> 16;
				l7 = k8;
		...
		private void Render(bool flag, bool flag1, int i)
		{
		...
		private void RenderTriangle(int i)
		{
			...
			if (i1 == 1)
			{
				Rasterizer.DrawFlatTriangle(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j], anIntArray1665[k], anIntArray1665[l], rgb_palette[anIntArray1634[i]]);
				return;
			}
			if (i1 == 2)
			{
			...
			if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0)
			{
				...
				if (l == 3)
				{
					...
					if (l7 == 0)
						...
						if (l7 == 1)
							Rasterizer.DrawFlatTriangle(i7, j7, k7, j3, j4, j5, rgb_palette[anIntArray1634[i]]);
						else
							if (l7 == 2)
							{
								...
								Rasterizer.DrawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[k9], anIntArray1668[k10], anIntArray1668[k11], anIntArray1669[k9], anIntArray1669[k10], anIntArray1669[k11], anIntArray1670[k9], anIntArray1670[k10], anIntArray1670[k11], anIntArray1640[i]);
							}
							else
								if (l7 == 3)
								{
									...
									Rasterizer.DrawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[l9], anIntArray1668[l10], anIntArray1668[l11], anIntArray1669[l9], anIntArray1669[l10], anIntArray1669[l11], anIntArray1670[l9], anIntArray1670[l10], anIntArray1670[l11], anIntArray1640[i]);
								}
				}
				if (l == 4)
				{
					...
					if (i8 == 1)
					{
						int l8 = rgb_palette[anIntArray1634[i]];
					...
					if (i8 == 2)
					{
						...
						Rasterizer.DrawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2], anIntArray1668[i10], anIntArray1668[i11], anIntArray1668[i12], anIntArray1669[i10], anIntArray1669[i11], anIntArray1669[i12], anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], anIntArray1640[i]);
					...
					if (i8 == 3)
					{
						...
						Rasterizer.DrawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i], anIntArray1668[j10], anIntArray1668[j11], anIntArray1668[j12], anIntArray1669[j10], anIntArray1669[j11], anIntArray1669[j12], anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], anIntArray1640[i]);
		...
		public VertexNormal[] aVertexNormalArray1660;
		...
		static Model()
		{
			SIN = Rasterizer.SIN;
			COS = Rasterizer.COS;
			rgb_palette = Rasterizer.rgb_palette;
